                ...
                >
                  ...
                  >
                    <h1
                      ...
                      onClick={() => handleFilterClick("Input Invoice ID")}
                    >
                      Invoice ID
                    </h1>
                    <h1
              ...
              <table className=" w-full border-separate border-spacing-y-5">
                <thead>
                  <tr className="text-left bg-[#E2E8F0] shadow-lg">
                    <th className="px-2 py-3 font-bold text-[17px]">
                      Invoice ID
                    </th>
                    <th className="px-2 py-3 font-bold text-[17px] text-center">
                      Store Owner
                    </th>
                    <th className="px-2 py-3 font-bold text-[17px] text-center">
                      Amount
                    ...
                    <th className="px-2 py-3 font-bold text-[17px] text-center">
                      ...
                      <div className="">
                        <p className="text-[12px] text-[#7E76BC]">
                          Download PDF
                        </p>
                        <p className="text-[12px] text-[#7E76BC]">
                          Send Reminder
