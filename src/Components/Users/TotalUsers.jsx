      ...
      <div className="bg-[#F5F5F5] pb-20">
        <div className="flex">
          ...
          <div className="flex-grow lg:ml-64">
                ...
                >
                  ...
                  >
                    <h1
                      ...
                      onClick={() => handleFilterClick("Input User Name")}
                    >
                      User Name
                    </h1>
                    <h1
                      className="text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer"
                      onClick={() => handleFilterClick("Input User ID")}
                    >
                      User ID
                    </h1>
                    <h1
                      className="text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer"
                      onClick={() => handleFilterClick("Input Email")}
                    >
                      Email
                    </h1>
                    <h1
                      className="text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer"
                      onClick={() => handleFilterClick("Input Role")}
                    >
                      Role
                    </h1>
                    <h1
                      className="text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer"
                      onClick={() => handleFilterClick("Input Status")}
                    >
                      Status
                    </h1>
                  </div>
            ...
            {/* Popup Component for filter section dropdown */}
            {popupVisible && (
              ...
              <table className=" w-full border-separate border-spacing-y-5">
                <thead>
                  <tr className="text-left bg-[#E2E8F0] shadow-lg">
                    ...
                    <th className="px-2 py-3 font-bold text-[14px] text-center flex items-center justify-center gap-2">
                      Bulk Action
                      <div>
                        <img src={edit} alt="" />
                      </div>
                ...
                <tbody>
                  ...
                  <tr className="bg-[#ffffff] shadow-md">
                    ...
                    <td className="px-2 py-3 text-[#6E6E6E] text-center flex justify-center">
                      <UserEdit />
                    </td>
