            ...
            <div className="mt-40 px-24">
              <div className="flex items-center justify-center gap-3 px-20 mt-10">
                ...
                <div className="flex items-center gap-2">
                  <div>
                    <h1 className="bg-[#6E6E6E] p-2 w-fit rounded-md text-[#ffffff]">
                      All
                    </h1>
                  </div>
                  <div>
                  ...
                  <div className="bg-[#E2E8F0] w-fit p-5 rounded-lg mt-7">
                    <div className="flex gap-5">
                      <h1 className="text-[#6E6E6E]">
                        Lorem ipsum dolor sit amet consectetur. Nulla amet{" "}
                        <br /> rutrum nulla lorem sit. Eu pharetra magna eget{" "}
                        <br /> risus malesuada pretium tortor commodo <br />{" "}
                        consectetur. Elementum purus.
                      </h1>
                      <div>
                        <p className="text-[#333333] font-bold text-center">
                          9:41am
                        </p>
                        <p className="text-[#7E76BC] font-extrabold text-center mt-2">
                          Mark As read
                        </p>
                        <p className="text-[#7E76BC] font-extrabold text-center mt-2">
                          Delete
                  ...
                  <div className="bg-[#FFFFFF] w-fit p-5 rounded-lg mt-7">
                    <div className="flex gap-5">
                      ...
                      <div>
                        ...
                        <p className="text-[#7E76BC] font-extrabold text-center mt-1">
                          Delete
                        </p>
                      </div>
                    </div>
